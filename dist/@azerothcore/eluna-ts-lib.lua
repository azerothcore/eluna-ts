...
["db.helpers"] = function() require("lualib_bundle");
local ____exports = {}
function ____exports.stringSanitizer(self, str)
    return select(
        1,
        string.gsub(str, "[';\\, ]", "")
    )
...
["hook.helpers"] = function() require("lualib_bundle");
local ____exports = {}
return ____exports
end,
...
local ____exports = {}
do
    local ____export = require("db.helpers")
